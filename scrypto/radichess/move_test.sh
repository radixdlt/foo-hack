...
resim set-default-account $redfoo_account $redfoo_privkey
# resim call-method $game1 move_piece "C4" "G8" 1,$badgerez # Correctly id'd as illegal
resim call-method $game1 move_piece "C4" "D3" 1,$badgerez # Correctly allows backwards move
resim set-default-account $rock_account $rock_privkey
resim call-method $game1 move_piece "D7" "D5" 1,$badgerez

resim set-default-account $redfoo_account $redfoo_privkey
# resim call-method $game1 move_piece "D2" "D4" 1,$badgerez # Correctly id'd as illegal
resim call-method $game1 move_piece "G1" "E2" 1,$badgerez
resim set-default-account $rock_account $rock_privkey
resim call-method $game1 move_piece "D5" "D4" 1,$badgerez

resim set-default-account $redfoo_account $redfoo_privkey
resim call-method $game1 move_piece "C2" "C4" 1,$badgerez
resim set-default-account $rock_account $rock_privkey
resim call-method $game1 move_piece "D4" "C3" 1,$badgerez # en passant allowed but no capture!
